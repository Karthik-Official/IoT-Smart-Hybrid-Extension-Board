...
#define TOUCH_SENSOR_1 16 //D0
#define TOUCH_SENSOR_2 10 //SD3
            ...
            if (client.available()) {             // if there's bytes to read from the client,
                ...
                if (c == '\n') {                    // if the byte is a newline character
                    ...
                    if (currentLine.length() == 0) {
                        ...
                        client.println("<script>function autoRefresh() {window.location.href = window.location.protocol + '//' + window.location.hostname;} setInterval(autoRefresh, 500); </script></head>");
                        
                        // Web Page Heading
                        client.println("<body><h1>Smart Extension Board (ESP8266)</h1>");

                        // Updating all switches
                        client.println("<p><h2 name='s1'>");
                        if (relayState1==0) {
